            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Ajouter mode de formation</li>
                    </ol>
                </div>
            </div>

        <form id="" action="{{route('SaveModeForma')}}" method="post">
            {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-info ">
                    <div class="panel-heading"><strong>Mode de la formation</strong> <a style="float: right" href="{{ route('ShowModeForma') }}" title="Lister les societes" class="glyphicon glyphicon-align-justify"></a></div>
