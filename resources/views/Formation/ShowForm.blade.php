            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Catégories des formations</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-primary ">
                    <div class="panel-heading">Catégories des formations: <span class="badge">{{ \App\Categorie::count() }} catégorie(s)</span> </div>
                    <div class="panel-body">
                       <div class="row">
                           <form action="SaveCatForm" method="post">
                               {{ csrf_field() }}
                            <div class="col-lg-4">
                                    ...
                                    <tr id="{{$CF->id}}">
                                        ...
                                        <div class="modal fade" id="ModalEdit{{$CF->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <form action="UpdateCatForm" method="post" name="CAT{{$CF->id}} " id="CAT{{$CF->id}}">
                                                    {{csrf_field()}}
                                        ...
                                        <div class="modal fade" id="ModalDel{{$CF->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                                            <div class="modal-dialog" role="document">
                                                <form action="DelCatForm" method="post" name="CATDel{{$CF->id}} " id="CAT{{$CF->id}}">
                                                    {{csrf_field()}}
                                                    <input type="hidden" name="id" id="id" value="{{$CF->id}}">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="alert alert-danger">
                                                                Les diplômes associés à cette catégories seront supprimés!
                                                            </div>
