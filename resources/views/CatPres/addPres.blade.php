...
@section('content')
    <div class="container">
        ...
        <form id="" action="{{route('SavePres')}}" method="post">
            {{ csrf_field() }}
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-info ">

                    <div class="panel-heading"><strong>Nouveau préstataire:</strong> <span class="badge">{{ \App\prestataire::count() }} préstataire(s)</span> <a style="float: right" href="{{ route('ShowPres') }}" title="Ajouter un nouveau préstataire" class="glyphicon glyphicon-align-justify"></a> </div>
